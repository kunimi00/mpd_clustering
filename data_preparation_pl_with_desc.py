...
all_pl_with_description = load_json_to_dict('data_pl_desc/all_pl_with_description.json')
...
for _idx in tqdm(range(len(all_pl_with_description))):
    ...
    pl_Y_desc[_pl['pid']] = _pl['description']
    pl_Y_title[_pl['pid']] = normalize_name(_pl['name'])

    pl_X_list.append(_pl_feature)
    pl_Y_desc_list.append(_pl['description'])
    pl_Y_title_list.append(normalize_name(_pl['name']))


save_dict_as_json(pl_X, 'data_pl_desc/pl_X_dict.json')
save_dict_as_json(pl_Y_desc, 'data_pl_desc/pl_Y_desc_dict.json')
save_dict_as_json(pl_Y_title, 'data_pl_desc/pl_Y_title_dict.json')

save_dict_as_json(pl_id_to_key_dict, 'data_pl_desc/pl_id_to_key_dict.json')
save_dict_as_json(pl_key_to_id_dict, 'data_pl_desc/pl_key_to_id_dict.json')

save_list_as_txt(pl_X_list, 'data_pl_desc/pl_X_list.txt')
save_list_as_txt(pl_Y_desc_list, 'data_pl_desc/pl_Y_desc_list.txt')
save_list_as_txt(pl_Y_title_list, 'data_pl_desc/pl_Y_title_list.txt')

pl_X_arr = np.array([pl_X_list])
np.save('data_pl_desc/pl_X_arr.npy', pl_X_arr)
